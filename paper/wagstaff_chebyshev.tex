...
see \S8.7 for the software toolchain and ``Supplementary material''
...
(proved for \(p \leq 42737\); see \S8.1) with \(p > 2617\), the exponents \(p = 10501\) and \(p = 12391\) are
...
described in \S8.5.
We summarise four outputs: the local-pass witnesses (\S8.5
...
count observed (see the Zenodo supplementary scripts for details).
